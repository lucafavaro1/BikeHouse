import { Button, Row, Nav, InputGroup, Modal } from "react-bootstrap";
          ...
          <Form>
            ...
            <Row>
              ...
              <Button
                ...
                //   onClick={(e) => {
                //     console.log(
                //       "brand: %s, model = %s, type = %s, location: %s, price: %d, framesize: %s, framematerial: %s, color: %s, gender: %s, frontgears: %d, reargears: %d, braketype: %s ",
                //       brand,
                //       model,
                //       type,
                //       location,
        ...
        return (
          <Form>
            ...
            <div className="initialText">
              ...
              <hr></hr>
              <Form.Check>
                <Form.Check.Input type="checkbox" id="condition_verification" />
                <Form.Check.Label>
                  {" "}
              ...
              <Form.Check>
                <Form.Check.Input type="checkbox" id="frame_verification" />
                <Form.Check.Label>
                  {" "}
